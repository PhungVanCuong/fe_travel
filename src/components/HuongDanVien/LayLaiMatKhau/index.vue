              ...
              <form @submit.prevent="doiMatKhau" class="bieu-mau-lay-lai-mk">
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="nhom-nhap-lieu">
                    <label class="form-label text-secondary fw-bold small mb-2">Mã Khôi Phục (Từ Email)</label>
                    <div class="bao-o-nhap">
                      <span class="bieu-tuong-o-nhap"><i class="fa-solid fa-barcode"></i></span>
                      <input v-model="reset.ma_khoi_phuc" type="text" class="o-nhap-lieu font-monospace fw-bold" placeholder="Nhập mã khôi phục..." required>
                    </div>
                  </div>

                  <!-- Mật khẩu mới -->
                  <div class="nhom-nhap-lieu">
                    <label class="form-label text-secondary fw-bold small mb-2">Mật khẩu mới</label>
                    <div class="bao-o-nhap">
                  ...
                  <div class="nhom-nhap-lieu">
                    <label class="form-label text-secondary fw-bold small mb-2">Xác nhận mật khẩu mới</label>
                    <div class="bao-o-nhap">
...
export default {
    ...
    methods: {
        doiMatKhau() {
            ...
            axios.post(apiUrl('huong-dan-vien/lay-lai-mat-khau'), this.reset)
                .then((response) => {
