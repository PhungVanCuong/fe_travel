        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5 mx-auto">
          ...
          <div class="the-dang-nhap">
            <div class="noi-dung-the">
              <h3 class="tieu-de-the">CỔNG HƯỚNG DẪN VIÊN</h3>
              <p class="text-center text-muted mb-4 small">Đăng nhập để xem lịch trình tour và danh sách khách hàng.</p>
                ...
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="nhom-nhap-lieu">
                    <div class="bao-o-nhap">
                      ...
                      <input v-model="user.email" type="text" class="o-nhap-lieu" placeholder="Email đăng nhập" />
                    </div>
                  </div>
              ...
              <p class="duong-dan-dang-ky mt-4">
                ...
                <router-link to="/huong-dan-vien/dang-ky">Đăng ký đối tác</router-link>
              </p>
