<template>
  <div class="khung-quen-mat-khau">
    <div class="nen-quen-mat-khau"></div>

    <div class="bao-quen-mat-khau container">
      <div class="row justify-content-center">
        <!-- Khống chế độ rộng cột y hệt form đăng ký/đăng nhập -->
            ...
            <div class="noi-dung-the">
              ...
              <form @submit.prevent="guiMail" class="bieu-mau-quen-mk">
                <div class="nhom-nhap-lieu mb-4">
                  <label class="form-label fw-semibold text-secondary small mb-2">Địa chỉ Email đã đăng ký</label>
...
export default {
    data() {
        return {
            email: null,
            isLoading: false // Biến chạy loading xoay xoay lúc gửi mail
        }
    },
    methods: {
        guiMail() {
...
.bao-quen-mat-khau { position: relative; z-index: 1; }
...
.o-nhap-lieu {
  ...
  padding: 15px 16px 15px 48px; font-size: 15px; font-family: inherit;
