<template>
  <div class="tour-browse-container" style="background-color: #F2F7FA; min-height: 100vh; padding-bottom: 50px;">
    ...
    <div class="page-header text-center py-5 text-white" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1920&q=80') center/cover;">
      <h1 class="display-4 fw-bold">Khám Phá Thế Giới 123</h1>
          ...
          <div class="sidebar-sticky">
            ...
            <div class="filters-wrapper p-4 rounded-4 bg-white shadow-sm border-0 mb-4">
              ...
              <div class="filter-group mb-4">
                <h6 class="fw-bold mb-3 d-flex align-items-center"><i class="bi bi-geo-alt-fill text-success me-2"></i> Quốc gia</h6>
              ...
              <div class="filter-group mb-4">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur1" value="1-3" v-model="filterDuration">
                  <label class="form-check-label text-secondary" for="dur1">Ngắn ngày (1 - 3 ngày)</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur2" value="4-5" v-model="filterDuration">
                  <label class="form-check-label text-secondary" for="dur2">Trung bình (4 - 5 ngày)</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur3" value="6+" v-model="filterDuration">
                  <label class="form-check-label text-secondary" for="dur3">Dài ngày (Từ 6 ngày)</label>
                </div>
              </div>
              ...
              <div class="filter-group mb-4">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" id="price1" value="<10000000" v-model="priceRanges">
                  <label class="form-check-label text-secondary" for="price1">Dưới 10 triệu</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" id="price2" value="10000000-20000000" v-model="priceRanges">
                  <label class="form-check-label text-secondary" for="price2">10 - 20 triệu</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" id="price3" value=">20000000" v-model="priceRanges">
                  <label class="form-check-label text-secondary" for="price3">Trên 20 triệu</label>
                </div>
              </div>
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center bg-white p-3 rounded-4 shadow-sm mb-4">
            <div class="input-group w-50">
              ...
              <input type="text" class="form-control border-start-0 ps-0 shadow-none" placeholder="Tìm tên tour quốc tế..." v-model="filterSearch">
            </div>
      ...
      baiVietNoiBat: [
        {
          ...
          tag: 'Thủ tục, Visa',
          hinh_anh: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=150&q=80'
        },
        {
          tieu_de: 'Bí kíp sắp xếp hành lý khi đi du lịch nước ngoài',
          tag: 'Cẩm nang, Mẹo vặt',
          hinh_anh: 'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&w=150&q=80'
        },
        {
          tieu_de: 'Thanh toán VNPay quốc tế - An toàn, tiện lợi',
          tag: 'Thanh toán',
          hinh_anh: 'https://vnpay.vn/s1/statics.vnpay.vn/2023/9/06ncktiwd6dc1694418196384.png'
        }
      ],
      ...
      if (this.priceRanges.length > 0) {
        results = results.filter(t => {
          ...
          return this.priceRanges.some(r => {
            if (r === '<10000000') return price < 10000000;
            if (r === '10000000-20000000') return price >= 10000000 && price <= 20000000;
            if (r === '>20000000') return price > 20000000;
          });
        });
      }
