            ...
            <div class="filters-wrapper p-4 rounded-4 bg-white shadow-sm border-0 mb-4">
              ...
              <div class="filter-group mb-4">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur1" value="1-3"
                    v-model="filterDuration">
                  <label class="form-check-label text-secondary" for="dur1">Ngắn ngày (1 - 3 ngày)</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur2" value="4-5"
                    v-model="filterDuration">
                  <label class="form-check-label text-secondary" for="dur2">Trung bình (4 - 5 ngày)</label>
                </div>
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="duration" id="dur3" value="6+"
                    v-model="filterDuration">
              ...
              <div class="filter-group mb-4">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" id="price2" value="10000000-20000000"
                    v-model="priceRanges">
